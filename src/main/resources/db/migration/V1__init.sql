...
CREATE TABLE buckets (
                         ...
                         CONSTRAINT buckets_user_id_key UNIQUE (user_id)
);
...
ALTER TABLE buckets
    ADD CONSTRAINT fknl0ltaj67xhydcrfbq8401nvj FOREIGN KEY (user_id)
        REFERENCES users (id) ON DELETE CASCADE;

ALTER TABLE users
    ADD COLUMN bucket_id BIGINT,
    ADD CONSTRAINT fk8l2qc4c6gihjdyoch727guci FOREIGN KEY (bucket_id)
        REFERENCES buckets (id) ON DELETE SET NULL;
